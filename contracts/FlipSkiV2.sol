...
/**
 * @title FlipSki V2 - Unified Multi-Token Coin Flip Game
 * @dev A unified contract for coin flip games supporting both ETH and multiple ERC20 tokens
 * @author qdibs
 * 
 *  _____                                        _____ 
 *( ___ )                                      ( ___ )
...
contract FlipSkiV2 is AccessControl, ReentrancyGuard, Pausable, VRFConsumerBaseV2Plus {
    ...
    // Game configuration
    uint256 public feePercentage; // In basis points (500 = 5%)
